...
menuItem4 = MenuItem(name="Cauliflower Manchurian",
                     description="Golden fried cauliflower florets in a midly spiced soya,garlic sauce cooked with "
...
menuItem5 = MenuItem(name="Aloo Gobi Burrito",
                     description="Vegan goodness. Burrito filled with rice, garbanzo beans, curry sauce, potatoes ("
                                 "aloo), fried cauliflower (gobi) and chutney. Nom Nom",
                     price="", course="", restaurant=restaurant1)
...
menuItem1 = MenuItem(name="Lamb Curry",
                     description="Slow cook that thang in a pool of tomatoes, onions and alllll those tasty Indian "
                                 "spices. Mmmm.",
                     price="", course="", restaurant=restaurant1)
...
menuItem1 = MenuItem(name="Boysenberry Sorbet",
                     description="An unsettlingly huge amount of ripe berries turned into frozen (and seedless) "
                                 "awesomeness",
                     price="", course="", restaurant=restaurant1)
...
menuItem4 = MenuItem(name="Tandoori Chicken",
                     description="Chicken marinated in yoghurt and seasoned with a spicy mix(chilli, tamarind among "
                                 "others) and slow cooked in a cylindrical clay or metal oven which gets its heat "
...
menuItem2 = MenuItem(name="Cachapa",
                     description="Golden brown, corn-based venezuelan pancake; usually stuffed with queso telita or "
